...
@section('title','Shikhi | Create Lesson')
@section('page','Create Lesson')
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Create Lesson</h4>
...
<form id="createform" action="{{ route('lesson.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="lesson_title" id="lesson_title" value="{{ old('lesson_title') }}" placeholder="Enter Lesson title" required="" />
            ...
            <div class="card d-none">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="course_id" id="course_id" value="{{ request('course_id') }}" placeholder="Enter Lesson title" required="" />
